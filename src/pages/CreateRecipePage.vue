        ...
        <div class="card">
          <div class="card-header">
            <h2 class="mb-0">
              ...
              {{ isFamilyRecipe ? 'Create Family Recipe' : 'Create New Recipe' }}
            </h2>
          </div>
          <div class="card-body">
            <form @submit.prevent="createRecipe">
              ...
              <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <router-link :to="{ name: 'myRecipes' }" class="btn btn-secondary me-md-2">Cancel</router-link>
...
export default {
  ...
  setup() {
    ...
    const isFamilyRecipe = ref(false);
    ...
    onMounted(() => {
      ...
      if (route.query.family === 'true') {
        recipe.isFamilyRecipe = true;
        isFamilyRecipe.value = true;
      }
    });
